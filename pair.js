            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'NASHE-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
                    ...
                    const MALVIN_TEXT = `
🎉 *Welcome to NASHE_MD BY THRI_IZ_KIDD!* 🚀  
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://whatsapp.com/channel/0029Vasurr4EquiXeN7EpK3N) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [King GitHub Repo](https://github.com/KINGZORD263)  

🚀 _Thanks for choosing NASHE_MD — Let the automation begin!_ ✨`;
